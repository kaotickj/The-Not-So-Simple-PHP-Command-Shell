...
If using the select field, choose your file and click "upload". files linked in the select field options need to be present at the web root<sup>1</sup> at the ip address and port in lines 10 and 11 of nsscmdshell.php. <br>
...
<sub>1</sub> I generally cd into my "windowstools" folder and start a simple http server:<br>
